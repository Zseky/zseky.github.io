ig.module('game.entities.buttons.button-next-level')
.requires(
	'game.entities.buttons.button'
)
.defines(function() {
	EntityButtonNextLevel = EntityButton.extend({
        animSheet: new ig.AnimationSheet('media/graphics/sprites/games/resume.png',122,122),
        isEnabled: true,
