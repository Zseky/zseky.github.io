ig.module('game.entities.buttons.button-double-reward')
.requires(
	'game.entities.buttons.button'
)
.defines(function() {
	EntityButtonDoubleReward = EntityButton.extend({
        animSheet: new ig.AnimationSheet('media/graphics/sprites/games/reward-button.png',428,101),
        isEnabled: true,
