ig.module('game.entities.buttons.button-switch-level-page-right')
.requires(
	'game.entities.buttons.button'
)
.defines(function() {
	EntityButtonSwitchLevelPageRight = EntityButton.extend({
        animSheet: new ig.AnimationSheet('media/graphics/sprites/games/right_button.png',122,122),
        isEnabled: true,
